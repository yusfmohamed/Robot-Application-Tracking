...
const DESTINATION_OPTIONS = ['Station 1', 'Station 2', 'Station 3', 'Loading Bay', 'Exit Point'];
        ...
        <View style={styles.card}>
          ...
          <View style={styles.locationHeader}>
            ...
            <Svg width="12" height="8" viewBox="0 0 12 8" fill="none">
              <Path d="M1 1L6 6L11 1" stroke="#1A3550" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
            </Svg>
          </View>
          ...
          <TouchableOpacity
            ...
            onPress={() => { setPickupOpen(!pickupOpen); setDestinationOpen(false); }}
          >
            <Text style={styles.dropdownText}>{selectedPickup}</Text>
            <Svg width="12" height="8" viewBox="0 0 12 8" fill="none">
          ...
          {pickupOpen && (
            <View style={styles.dropdownList}>
              {PICKUP_OPTIONS.map(option => (
                <TouchableOpacity
                  key={option}
                  style={[styles.dropdownItem, selectedPickup === option && styles.dropdownItemActive]}
                  onPress={() => handlePickup(option)}
                >
                  <Text style={[styles.dropdownItemText, selectedPickup === option && styles.dropdownItemTextActive]}>
                    {option}
                  </Text>
                </TouchableOpacity>
              ))}
